...
public class Fence2 extends Activity implements AMapLocationListener,
        OnMapClickListener {
    ...
    private void init(Bundle savedInstanceState) {
        ...
        markOptions.icon(BitmapDescriptorFactory.fromBitmap(BitmapFactory.decodeResource
                (getResources(), R.drawable.mylocation))).anchor(0.5f, 0.5f);
    ...
    public void onMapClick(LatLng latLng) {
        ...
        mLocationManagerProxy.addGeoFenceAlert(latLng.latitude,
                latLng.longitude, 1000,1000 * 60 , mPendingIntent);
        // 将地理围栏添加到地图上显示
